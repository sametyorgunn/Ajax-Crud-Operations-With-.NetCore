...
namespace jquery.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult Personelsil(int id)
        {
            ...
            var kisi = c.kisilers.Find(id);
            c.kisilers.Remove(kisi);
            c.SaveChanges();
            return Ok();
        ...
        [HttpPost]
        public IActionResult PersonelGuncelle(kisiler kisiler)
        {
            Context c = new Context();
            //var kisi = c.kisilers.Find();
            c.kisilers.Update(kisiler);
            c.SaveChanges();
            return Ok();
        }
